...
class RequestForm(FlaskForm):
    start_date = DateField("Checkout date", format='%Y-%m-%d', validators=[DataRequired(message='Enter checkout date in format: %d/%m/%y')])
    end_date = DateField("Return date", format='%Y-%m-%d', validators=[DataRequired(message='Enter return date in format: %d/%m/%y')])
