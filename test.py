...
class FlaskTestCase(unittest.TestCase):
    ...
    def test_correct_login(self):
        response = tester.post('http://ec2-18-219-248-53.us-east-2.compute.amazonaws.com/login', data = dict(email="xd@gmail.com", password="111"))
    ...
    def test_incorrect_login(self):
        response = tester.post('/login', data = dict(username="incorrect@email.com", password="hunter12"))
